...
var startGame = function() {
    ...
    for(var i = 0; i < enemyInfo.length; i++) {
        if (playerInfo.health > 0) {
            ...
            // set health property to pickedEnemyObj and consequently 'enemy' parameter in fight function before starting new fight
...
var endGame = function() {
    ...
    // alternatively, use short circuit conditional statement
